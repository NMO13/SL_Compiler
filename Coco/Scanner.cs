...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "BEGIN": t.kind = 5; break;
			case "END": t.kind = 6; break;
			case "VAR": t.kind = 8; break;
			case "PROCEDURE": t.kind = 12; break;
			case "IF": t.kind = 16; break;
			case "THEN": t.kind = 17; break;
			case "ELSIF": t.kind = 18; break;
